            ...
            <table id="report-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                    <th>{{ $order->id }}</th>
                    <th>{{ $order->code }}</th>
                    <th>{{ $order->rumah->perumahan->name }} Blok {{ $order->rumah->block }}/{{ $order->rumah->number }}</th>
                    <th>{{ $order->valid_until }}</th>
                    <th>{{ $order->confirmed ? 'Sudah Konfirmasi':'Belum Konfirmasi' }}</th>
                    <td>{{ $order->total }}</td>
                  </tr>
                @endforeach
              </tbody>
